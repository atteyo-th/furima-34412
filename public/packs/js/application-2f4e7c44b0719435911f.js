...
var pay = function pay() {
  Payjp.setPublicKey("pk_test_271a59e2c79dbdfd3a607738"); // PAY.JPテスト公開鍵
  ...
  form.addEventListener("submit", function (e) {
    ...
    var card = {
      ...
      exp_year: "20".concat(formData.get("purchase_form[year]"))
    };
    console.log(card);
    debugger;
    Payjp.createToken(card, function (status, response) {
      ...
      document.getElementById("purchase_form_cvc").removeAttribute("name");
      document.getElementById("purchase_form_month").removeAttribute("name");
      document.getElementById("purchase_form_year").removeAttribute("name");
...
/******/ });
//# sourceMappingURL=application-2f4e7c44b0719435911f.js.map